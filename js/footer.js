export default {
    ...
    <footer class="item3">
        <div class="footer-section">
            <img src="images/yoda.png" alt="Logo de la empresa" id="menu-icon" class="footer-image">
        </div>
        ...
        <div class="footer-section">
            <h4 class="contact-info">Contactános</h4><br>
            <p class ="contact-info">+5491124014027</p><br>
            <p class ="contact-info">ventas@span.com.ar</p><br>
